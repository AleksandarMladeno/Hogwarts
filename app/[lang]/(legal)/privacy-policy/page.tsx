    ...
    <>
      ...
      <div className="px-8 py-12 space-y-2">
        ...
        <p>
          ...
          shared and/or collect in Hogwarts.gg. This policy is not applicable to
        ...
        <p>
          ...
          about you such as your name, steam username, the contents of the
          message and/or attachments you may send us, and any other information
          you may choose to provide.
        </p>
        <p>
          When you register for an Account, we may ask for your steam
          information, including items such as name and Steam ID.
        </p>
        ...
        <p>
          Hogwarts.gg follows a standard procedure of using log files. These
        ...
        <p>
          Like any other website, Hogwarts.gg uses &apos;cookies&apos;. These
        ...
        <p>
          ...
          advertising partners of Hogwarts.gg.
        </p>
        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Hogwarts.gg, which are sent
        ...
        <p>
          Note that Hogwarts.gg has no access to or control over these cookies
          that are used by third-party advertisers.
        </p>
        <h2 className="text-xl">Third Party Privacy Policies</h2>
        <p>
          Hogwarts.gg&apos;s Privacy Policy does not apply to other advertisers
        ...
        <p>
          Hogwarts.gg does not knowingly collect any Personal Identifiable
